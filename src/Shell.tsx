...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#fbfbfc] text-zinc-900 font-sans antialiased selection:bg-indigo-500/20 selection:text-indigo-900 flex flex-col relative overflow-x-hidden">
      {/* Ambient Fluid Refraction Light Fields (Provides underlying color spectra for liquid glass refraction) */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 opacity-55">
        <div className="absolute -top-[12%] -left-[10%] w-[55vw] h-[55vw] rounded-full bg-gradient-to-br from-indigo-200/50 via-sky-200/35 to-transparent blur-[140px]" />
        <div className="absolute top-[22%] -right-[12%] w-[50vw] h-[50vw] rounded-full bg-gradient-to-bl from-purple-200/45 via-violet-100/35 to-transparent blur-[150px]" />
        <div className="absolute top-[60%] -left-[8%] w-[45vw] h-[45vw] rounded-full bg-gradient-to-tr from-teal-200/35 via-emerald-100/30 to-transparent blur-[140px]" />
        <div className="absolute -bottom-[8%] right-[8%] w-[50vw] h-[50vw] rounded-full bg-gradient-to-tl from-indigo-100/55 via-blue-100/40 to-transparent blur-[140px]" />
      </div>

      {/* Apple Liquid Glass Sticky Header */}
      <header className="sticky top-0 z-30 h-16 liquid-glass-header px-3 sm:px-6 md:px-8 flex items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-3 sm:gap-4 flex-1 max-w-xl">
          ...
          {/* Quick Search with ⌘K & Inset Liquid Glass Well */}
          <div className="relative w-full max-w-sm">
            ...
            <input
              ...
              className="w-full pl-8 pr-12 py-1.5 text-xs liquid-glass-input text-zinc-900 placeholder:text-zinc-400 outline-none"
            />
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          <div
            ...
            className="relative inline-flex items-center p-0.5 rounded-full liquid-glass-pill shrink-0"
          >
          ...
          {/* Liquid Glass Funds Pill */}
          <button
            type="button"
            onClick={() => go('/wallet')}
            className={`liquid-glass-pill px-2.5 sm:px-3 py-1 text-[11px] transition-all flex items-center gap-1.5 shrink-0 cursor-pointer spring-press hover:-translate-y-0.5 ${
              route === '/wallet'
                ? 'bg-zinc-900 text-white border-zinc-900 font-semibold shadow-md'
                : 'text-zinc-800'
            }`}
          ...
          <div className="relative shrink-0">
            ...
            {notifOpen && (
              <div className="absolute right-0 mt-2 w-72 sm:w-80 liquid-glass-floating rounded-2xl shadow-xl p-2 z-40 animate-in fade-in zoom-in-95 duration-150">
          ...
          {/* User Account / Profile Liquid Glass Pill */}
          <button
            type="button"
            onClick={openUserProfileDrawer}
            className="liquid-glass-pill flex items-center gap-1.5 p-1 sm:px-2.5 sm:py-1 transition-all spring-press shrink-0 cursor-pointer hover:-translate-y-0.5"
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1 text-xs font-semibold text-indigo-700 liquid-glass-button-secondary rounded-full transition-all shrink-0 cursor-pointer"
      ...
      <div className="flex-1 flex flex-col min-h-screen pb-28 sm:pb-36 relative z-10">
