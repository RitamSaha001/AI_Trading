...
export function freshState(customCash = 50000, mode: SimulationMode = 'clean'): AppState {
  ...
  const initialStrategies: StrategyConfig[] = [
    ...
    {
      id: 'strat_reliance_apex',
      asset: 'RELIANCE',
      kind: 'titan_quantum',
      name: 'RELIANCE Titan Quantum Apex Sentinel (NSE)',
      enabled: true,
      maxAllocation: 0.25,
      cooldownSec: 180,
      tradesExecuted: 0,
    ...
    },
    {
      ...
      asset: 'TCS',
      kind: 'vwap_trend',
      name: 'TCS Institutional VWAP Trend Engine (NSE)',
      enabled: true,
      maxAllocation: 0.20,
      cooldownSec: 180,
      tradesExecuted: 0,
      ...
      targetProfitPct: 4.5,
      trailingStopPct: 1.5,
      params: { atrMultiplierTP: 3.2, atrMultiplierSL: 1.3, minAlphaScore: 35, regimeFilterEnabled: true },
    },
    {
      id: 'strat_hdfc_meanrev',
      asset: 'HDFCBANK',
      kind: 'mean_reversion',
      name: 'HDFCBANK Statistical Mean Reversion Sentinel (NSE)',
      enabled: true,
      maxAllocation: 0.20,
      cooldownSec: 180,
      tradesExecuted: 0,
      ...
      targetProfitPct: 4.0,
      trailingStopPct: 1.5,
      params: { atrMultiplierTP: 3.0, atrMultiplierSL: 1.25, minAlphaScore: 35, regimeFilterEnabled: true },
    },
    {
      id: 'strat_infy_breakout',
      asset: 'INFY',
      kind: 'breakout_volatility',
      name: 'INFY Volatility Breakout Sentinel (NSE)',
      enabled: true,
      maxAllocation: 0.20,
      cooldownSec: 180,
      tradesExecuted: 0,
      ...
      targetProfitPct: 5.5,
      trailingStopPct: 2.0,
      params: { atrMultiplierTP: 3.6, atrMultiplierSL: 1.35, minAlphaScore: 35, regimeFilterEnabled: true },
    },
  ];
