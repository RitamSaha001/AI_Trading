...
> = {
  RELIANCE: { name: 'Reliance Industries', symbol: 'RELIANCE', cbSymbol: 'NSE:RELIANCE', basePrice: 2800, decimals: 0, iconColor: '#0052cc', category: 'Indian Equities' },
  TCS: { name: 'Tata Consultancy Services', symbol: 'TCS', cbSymbol: 'NSE:TCS', basePrice: 4000, decimals: 0, iconColor: '#0070f3', category: 'Indian Equities' },
  INFY: { name: 'Infosys Limited', symbol: 'INFY', cbSymbol: 'NSE:INFY', basePrice: 1800, decimals: 0, iconColor: '#007cc3', category: 'Indian Equities' },
  HDFCBANK: { name: 'HDFC Bank Limited', symbol: 'HDFCBANK', cbSymbol: 'NSE:HDFCBANK', basePrice: 1600, decimals: 0, iconColor: '#004c8f', category: 'Indian Equities' },
  ICICIBANK: { name: 'ICICI Bank Limited', symbol: 'ICICIBANK', cbSymbol: 'NSE:ICICIBANK', basePrice: 1180, decimals: 0, iconColor: '#f37021', category: 'Indian Equities' },
  SBIN: { name: 'State Bank of India', symbol: 'SBIN', cbSymbol: 'NSE:SBIN', basePrice: 800, decimals: 0, iconColor: '#280071', category: 'Indian Equities' },
  BHARTIARTL: { name: 'Bharti Airtel Limited', symbol: 'BHARTIARTL', cbSymbol: 'NSE:BHARTIARTL', basePrice: 1580, decimals: 0, iconColor: '#e40000', category: 'Indian Equities' },
  ITC: { name: 'ITC Limited', symbol: 'ITC', cbSymbol: 'NSE:ITC', basePrice: 480, decimals: 0, iconColor: '#1d4ed8', category: 'Indian Equities' },
  ...
  LT: { name: 'Larsen & Toubro', symbol: 'LT', cbSymbol: 'NSE:LT', basePrice: 3500, decimals: 0, iconColor: '#eab308', category: 'Indian Equities' },
  TATAMOTORS: { name: 'Tata Motors Limited', symbol: 'TATAMOTORS', cbSymbol: 'NSE:TATAMOTORS', basePrice: 950, decimals: 0, iconColor: '#1e3a8a', category: 'Indian Equities' },
  ...
  HINDUNILVR: { name: 'Hindustan Unilever', symbol: 'HINDUNILVR', cbSymbol: 'NSE:HINDUNILVR', basePrice: 2650, decimals: 0, iconColor: '#005a9c', category: 'Indian Equities' },
  ...
  ONGC: { name: 'Oil & Natural Gas Corp', symbol: 'ONGC', cbSymbol: 'NSE:ONGC', basePrice: 290, decimals: 0, iconColor: '#b91c1c', category: 'Indian Equities' },
