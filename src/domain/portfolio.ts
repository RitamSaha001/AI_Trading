...
> = {
 ...
 HAL: { name: 'Hindustan Aeronautics', symbol: 'HAL', cbSymbol: 'NSE:HAL', basePrice: 4700, decimals: 0, iconColor: '#7f1d1d', category: 'Indian Equities' },
 BEL: { name: 'Bharat Electronics', symbol: 'BEL', cbSymbol: 'NSE:BEL', basePrice: 300, decimals: 0, iconColor: '#991b1b', category: 'Indian Equities' },
