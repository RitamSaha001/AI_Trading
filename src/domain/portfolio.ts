...
> = {
  RELIANCE: { name: 'Reliance Industries', symbol: 'RELIANCE', cbSymbol: 'NSE:RELIANCE', basePrice: 1295, decimals: 0, iconColor: '#0052cc', category: 'Indian Equities' },
  TCS: { name: 'Tata Consultancy Services', symbol: 'TCS', cbSymbol: 'NSE:TCS', basePrice: 2270, decimals: 0, iconColor: '#0070f3', category: 'Indian Equities' },
  INFY: { name: 'Infosys Limited', symbol: 'INFY', cbSymbol: 'NSE:INFY', basePrice: 1085, decimals: 0, iconColor: '#007cc3', category: 'Indian Equities' },
  HDFCBANK: { name: 'HDFC Bank Limited', symbol: 'HDFCBANK', cbSymbol: 'NSE:HDFCBANK', basePrice: 705, decimals: 0, iconColor: '#004c8f', category: 'Indian Equities' },
  ICICIBANK: { name: 'ICICI Bank Limited', symbol: 'ICICIBANK', cbSymbol: 'NSE:ICICIBANK', basePrice: 1405, decimals: 0, iconColor: '#f37021', category: 'Indian Equities' },
  SBIN: { name: 'State Bank of India', symbol: 'SBIN', cbSymbol: 'NSE:SBIN', basePrice: 1010, decimals: 0, iconColor: '#280071', category: 'Indian Equities' },
  BHARTIARTL: { name: 'Bharti Airtel Limited', symbol: 'BHARTIARTL', cbSymbol: 'NSE:BHARTIARTL', basePrice: 1840, decimals: 0, iconColor: '#e40000', category: 'Indian Equities' },
  ITC: { name: 'ITC Limited', symbol: 'ITC', cbSymbol: 'NSE:ITC', basePrice: 265, decimals: 0, iconColor: '#1d4ed8', category: 'Indian Equities' },
  KOTAKBANK: { name: 'Kotak Mahindra Bank', symbol: 'KOTAKBANK', cbSymbol: 'NSE:KOTAKBANK', basePrice: 1780, decimals: 0, iconColor: '#ed1c24', category: 'Indian Equities' },
  LT: { name: 'Larsen & Toubro', symbol: 'LT', cbSymbol: 'NSE:LT', basePrice: 3970, decimals: 0, iconColor: '#eab308', category: 'Indian Equities' },
  TATAMOTORS: { name: 'Tata Motors Limited', symbol: 'TATAMOTORS', cbSymbol: 'NSE:TATAMOTORS', basePrice: 305, decimals: 0, iconColor: '#1e3a8a', category: 'Indian Equities' },
  AXISBANK: { name: 'Axis Bank Limited', symbol: 'AXISBANK', cbSymbol: 'NSE:AXISBANK', basePrice: 1150, decimals: 0, iconColor: '#97144d', category: 'Indian Equities' },
  MARUTI: { name: 'Maruti Suzuki India', symbol: 'MARUTI', cbSymbol: 'NSE:MARUTI', basePrice: 12200, decimals: 0, iconColor: '#dc2626', category: 'Indian Equities' },
  SUNPHARMA: { name: 'Sun Pharma Industries', symbol: 'SUNPHARMA', cbSymbol: 'NSE:SUNPHARMA', basePrice: 1750, decimals: 0, iconColor: '#f97316', category: 'Indian Equities' },
  TITAN: { name: 'Titan Company Limited', symbol: 'TITAN', cbSymbol: 'NSE:TITAN', basePrice: 3400, decimals: 0, iconColor: '#059669', category: 'Indian Equities' },
  BAJFINANCE: { name: 'Bajaj Finance Limited', symbol: 'BAJFINANCE', cbSymbol: 'NSE:BAJFINANCE', basePrice: 7000, decimals: 0, iconColor: '#0284c7', category: 'Indian Equities' },
  HINDUNILVR: { name: 'Hindustan Unilever', symbol: 'HINDUNILVR', cbSymbol: 'NSE:HINDUNILVR', basePrice: 2450, decimals: 0, iconColor: '#005a9c', category: 'Indian Equities' },
  WIPRO: { name: 'Wipro Limited', symbol: 'WIPRO', cbSymbol: 'NSE:WIPRO', basePrice: 520, decimals: 0, iconColor: '#7c3aed', category: 'Indian Equities' },
  NTPC: { name: 'NTPC Limited', symbol: 'NTPC', cbSymbol: 'NSE:NTPC', basePrice: 390, decimals: 0, iconColor: '#047857', category: 'Indian Equities' },
  ONGC: { name: 'Oil & Natural Gas Corp', symbol: 'ONGC', cbSymbol: 'NSE:ONGC', basePrice: 270, decimals: 0, iconColor: '#b91c1c', category: 'Indian Equities' },
  HAL: { name: 'Hindustan Aeronautics', symbol: 'HAL', cbSymbol: 'NSE:HAL', basePrice: 5031, decimals: 0, iconColor: '#7f1d1d', category: 'Indian Equities' },
  BEL: { name: 'Bharat Electronics', symbol: 'BEL', cbSymbol: 'NSE:BEL', basePrice: 410, decimals: 0, iconColor: '#991b1b', category: 'Indian Equities' },
  TATASTEEL: { name: 'Tata Steel Limited', symbol: 'TATASTEEL', cbSymbol: 'NSE:TATASTEEL', basePrice: 184, decimals: 0, iconColor: '#0284c7', category: 'Indian Equities' },
