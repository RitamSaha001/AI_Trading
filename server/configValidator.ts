...
export function validateServerConfig(rawEnv: Record<string, any>): ValidationResult {
  ...
  const baseSchema = z.object({
    ...
    ALLOWED_ORIGINS: z.string().default('http://localhost:3000,http://localhost:5173,http://127.0.0.1:3000,https://ritamsaha001.github.io,https://87.76.191.49.nip.io,http://87.76.191.49.nip.io,http://87.76.191.49,https://87.76.191.49'),
